...
1. 📥 **[Download the latest osuaicoach.exe here](https://github.com/TapeSix/osu-ai-coach/releases)**
...
4. To see the stats, open the Windows tray and right-click on the program, then click Open Dashboard button.
